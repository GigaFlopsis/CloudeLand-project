...
public class GvrViewer : MonoBehaviour {
  ...
  /// @endcond
	...
	public String textScreenSizes;


	public void SwitchScreenSize()
	{
		sizeId = sizeId == 8 ? 0 : sizeId+1;

		switch(sizeId)
		{
		case 0:
			ScreenSize = GvrProfile.ScreenSizes.GalaxyNote4;
			textScreenSizes = "GalaxyNote4";
			break;
		case 1:
			ScreenSize = GvrProfile.ScreenSizes.GalaxyS6;
			textScreenSizes = "GalaxyS6";
			break;
		case 2:
			ScreenSize = GvrProfile.ScreenSizes.iPhone4;
			textScreenSizes = "iPhone4";
			break;
		case 3:
			ScreenSize = GvrProfile.ScreenSizes.iPhone5;
			textScreenSizes = "iPhone5";
			break;
		case 4:
			ScreenSize = GvrProfile.ScreenSizes.iPhone6;
			textScreenSizes = "iPhone6";
			break;
		case 5:
			ScreenSize = GvrProfile.ScreenSizes.iPhone6p;
			textScreenSizes = "iPhone6p";
			break;
		case 6:
			ScreenSize = GvrProfile.ScreenSizes.LGG3;
			textScreenSizes = "LGG3";
			break;
		case 7:
			ScreenSize = GvrProfile.ScreenSizes.Nexus5;
			textScreenSizes = "Nexus5";
			break;

		case 8:
			ScreenSize = GvrProfile.ScreenSizes.Nexus6;
			textScreenSizes = "Nexus6";
			break;
		}
	}
